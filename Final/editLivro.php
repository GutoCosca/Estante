    ...
    <main>
        ...
        <?php
            if (isset($_REQUEST['acao'])){
                ...
                if ($tblDados['arqempresta'] == 1) {
                    ...
                    $saida = $tblEmprest['dt_emprest'];
                    $nome = $tblEmprest['nome'];
                    $entra = $tblEmprest['dt_devol'];
                }
                else {
                    $saida = "";
                    $nome = "";
        ...
        <section id="idAltera">
            ...
            <form action="<?=$_SERVER['PHP_SELF']?>?acao=alterar&buscaCodigo=<?=$tblDados['id_livros']?>" method="post" enctype="multipart/form-data" id="idForm">
                ...
                <h3 class="emprestar" id="idTitEmprest"  <?=$display?>>Emprestado</h3>
            <div class="emprestar" id="idEmprest" <?=$display?>>
